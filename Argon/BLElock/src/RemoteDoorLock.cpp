...
#include "Particle.h"
#line 1 "/Users/lst97/Desktop/_temp/RemoteDoorLock/src/RemoteDoorLock.ino"
#include "TOTP.h"
void disconnect();
int get_door_status();
int get_lock_status();
...
void setup();
void loop();
#line 2 "/Users/lst97/Desktop/_temp/RemoteDoorLock/src/RemoteDoorLock.ino"
#define LOCK_UP 2
#define LOCK_DOWN 3
